...
- VS Code or similar (install suggested extensions and use workspace settings)
- NodeJS version 22 or higher. Use `nvm` to switch engines if needed.
- `pnpm` node package manager. Install here: [pnpm](https://pnpm.io/)
