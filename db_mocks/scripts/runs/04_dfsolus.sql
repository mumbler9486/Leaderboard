...
INSERT INTO dbo.RunParty
  (Id,RunId,PlayerId,Ordinal,PovLink,RunCharacterName,MainClass,SubClass,Weapons)
VALUES
  (44000,44000,1001,0,'https://youtu.be/615d0cda598f',N'trying_to_rid_this_name','ngs_bouncer','ngs_force', NULL),
  (44001,44000,1014,0,'https://youtu.be/e7b04887cbb5',N'trying_to_rid_this_name','ngs_fighter','ngs_slayer', NULL),
  (44002,44000,1003,0,'https://youtu.be/f56c221303be',N'trying_to_rid_this_name','ngs_force','ngs_fighter', NULL),
  (44003,44000,1012,0,'https://youtu.be/47e60a59444d',N'trying_to_rid_this_name','ngs_ranger','ngs_slayer', NULL),
  (44004,44000,1002,1,'https://youtu.be/8f8cf6e4c6b9',N'trying_to_rid_this_name','ngs_ranger','ngs_force', NULL),
  (44005,44000,5000000,1,'https://youtu.be/46e519ffd028',N'trying_to_rid_this_name','ngs_hunter','ngs_braver', NULL),
  (44006,44000,1005,1,'https://youtu.be/3029c188a8b0',N'trying_to_rid_this_name','ngs_force','ngs_fighter', NULL),
  (44007,44000,1006,1,NULL,N'trying_to_rid_this_name','ngs_techter','ngs_ranger', NULL),

  (44008,44001,1017,0,'https://youtu.be/6da1c17118d3',N'trying_to_rid_this_name','ngs_hunter','ngs_techter', NULL),
  (44009,44001,1013,0,NULL,N'trying_to_rid_this_name','ngs_gunner','ngs_force', NULL),
  (44010,44001,1016,0,NULL,N'trying_to_rid_this_name','ngs_hunter','ngs_bouncer', NULL),
  (44011,44001,1018,0,NULL,N'trying_to_rid_this_name','ngs_bouncer','ngs_gunner', NULL),
  (44012,44001,1009,1,NULL,N'trying_to_rid_this_name','ngs_force','ngs_braver', NULL),
  (44013,44001,1005,1,NULL,N'trying_to_rid_this_name','ngs_waker','ngs_ranger', NULL),
  (44014,44001,1012,1,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_slayer', NULL),
  (44015,44001,1026,1,NULL,N'trying_to_rid_this_name','ngs_bouncer','ngs_waker', NULL),

  (44016,44002,1011,0,'https://youtu.be/5b6d984f4821',N'trying_to_rid_this_name','ngs_fighter','ngs_bouncer', NULL),
  (44017,44002,1023,0,'https://youtu.be/1acc45a696dd',N'trying_to_rid_this_name','ngs_bouncer','ngs_gunner', NULL),
  (44018,44002,1021,0,'https://youtu.be/1c6f027e6420',N'trying_to_rid_this_name','ngs_force','ngs_techter', NULL),
  (44019,44002,1019,0,NULL,N'trying_to_rid_this_name','ngs_waker','ngs_ranger', NULL),
  (44020,44002,1030,1,NULL,N'trying_to_rid_this_name','ngs_bouncer','ngs_slayer', NULL),
  (44021,44002,1007,1,NULL,N'trying_to_rid_this_name','ngs_fighter','ngs_waker', NULL),
  (44022,44002,1027,1,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_braver', NULL),
  (44023,44002,1029,1,'https://youtu.be/76399eb7fd4b',N'trying_to_rid_this_name','ngs_hunter','ngs_fighter', NULL),

  (44024,44003,1013,0,'https://youtu.be/2a199ef3cb96',N'trying_to_rid_this_name','ngs_braver','ngs_hunter', NULL),
  (44025,44003,1009,0,'https://youtu.be/ca98b510cbc9',N'trying_to_rid_this_name','ngs_ranger','ngs_slayer', NULL),
  (44026,44003,1004,0,'https://youtu.be/edda2af8a573',N'trying_to_rid_this_name','ngs_ranger','ngs_slayer', NULL),
  (44027,44003,1028,0,'https://youtu.be/51b8769bf1c9',N'trying_to_rid_this_name','ngs_waker','ngs_fighter', NULL),
  (44028,44003,1006,1,'https://youtu.be/67ab8c3b5651',N'trying_to_rid_this_name','ngs_braver','ngs_force', NULL),
  (44029,44003,1001,1,'https://youtu.be/8eccf68cc323',N'trying_to_rid_this_name','ngs_gunner','ngs_braver', NULL),
  (44030,44003,1010,1,'https://youtu.be/c4ddf1ac1eee',N'trying_to_rid_this_name','ngs_waker','ngs_force', NULL),
  (44031,44003,1022,1,'https://youtu.be/e54bb3e9bb33',N'trying_to_rid_this_name','ngs_bouncer','ngs_waker', NULL),

  (44032,44004,5000000,0,'https://youtu.be/e8587c8a2ff5',N'trying_to_rid_this_name','ngs_slayer','ngs_techter', NULL),
  (44033,44004,1010,0,NULL,N'trying_to_rid_this_name','ngs_waker','ngs_bouncer', NULL),
  (44034,44004,1008,0,NULL,N'trying_to_rid_this_name','ngs_gunner','ngs_bouncer', NULL),
  (44035,44004,1009,0,NULL,N'trying_to_rid_this_name','ngs_waker','ngs_hunter', NULL),
  (44036,44004,1030,1,NULL,N'trying_to_rid_this_name','ngs_bouncer','ngs_braver', NULL),
  (44037,44004,1026,1,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_gunner', NULL),
  (44038,44004,1003,1,NULL,N'trying_to_rid_this_name','ngs_force','ngs_braver', NULL),
  (44039,44004,1013,1,'https://youtu.be/2a0f09f68a72',N'trying_to_rid_this_name','ngs_gunner','ngs_techter', NULL),

  (44040,44005,1011,0,'https://youtu.be/4b4c4521e3fe',N'trying_to_rid_this_name','ngs_waker','ngs_techter', NULL),
  (44041,44005,1010,0,'https://youtu.be/58374e339aa5',N'trying_to_rid_this_name','ngs_bouncer','ngs_waker', NULL),
  (44042,44005,1026,0,'https://youtu.be/ecd34c83d0c4',N'trying_to_rid_this_name','ngs_waker','ngs_hunter', NULL),
  (44043,44005,1001,0,'https://youtu.be/48cc2aefc421',N'trying_to_rid_this_name','ngs_braver','ngs_ranger', NULL),
  (44044,44005,1002,1,'https://youtu.be/bd40e6bdcf45',N'trying_to_rid_this_name','ngs_slayer','ngs_waker', NULL),
  (44045,44005,5000000,1,'https://youtu.be/f5d507c2ef3a',N'trying_to_rid_this_name','ngs_slayer','ngs_force', NULL),
  (44046,44005,1024,1,'https://youtu.be/74f43d4f8213',N'trying_to_rid_this_name','ngs_techter','ngs_waker', NULL),
  (44047,44005,1027,1,'https://youtu.be/7423efbaf930',N'trying_to_rid_this_name','ngs_hunter','ngs_waker', NULL),

  (44048,44006,1012,0,'https://youtu.be/5e5672fc7604',N'trying_to_rid_this_name','ngs_gunner','ngs_ranger', NULL),
  (44049,44006,1004,0,NULL,N'trying_to_rid_this_name','ngs_braver','ngs_ranger', NULL),
  (44050,44006,1028,0,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_hunter', NULL),
  (44051,44006,1015,0,'https://youtu.be/191f8cff35ca',N'trying_to_rid_this_name','ngs_gunner','ngs_braver', NULL),
  (44052,44006,1027,1,NULL,N'trying_to_rid_this_name','ngs_hunter','ngs_force', NULL),
  (44053,44006,1003,1,NULL,N'trying_to_rid_this_name','ngs_force','ngs_ranger', NULL),
  (44054,44006,1007,1,NULL,N'trying_to_rid_this_name','ngs_hunter','ngs_slayer', NULL),
  (44055,44006,1011,1,NULL,N'trying_to_rid_this_name','ngs_braver','ngs_ranger', NULL),

  (44056,44007,1013,0,'https://youtu.be/c1483d2ff265',N'trying_to_rid_this_name','ngs_fighter','ngs_bouncer', NULL),
  (44057,44007,1020,0,'https://youtu.be/06d7990d549d',N'trying_to_rid_this_name','ngs_force','ngs_hunter', NULL),
  (44058,44007,1023,0,'https://youtu.be/5752958c9ce1',N'trying_to_rid_this_name','ngs_hunter','ngs_fighter', NULL),
  (44059,44007,1007,0,'https://youtu.be/2c478ea10dc7',N'trying_to_rid_this_name','ngs_slayer','ngs_force', NULL),
  (44060,44007,1025,1,'https://youtu.be/79d478b478af',N'trying_to_rid_this_name','ngs_hunter','ngs_bouncer', NULL),
  (44061,44007,1014,1,'https://youtu.be/943fc8618520',N'trying_to_rid_this_name','ngs_waker','ngs_ranger', NULL),
  (44062,44007,1003,1,'https://youtu.be/088d3079b14b',N'trying_to_rid_this_name','ngs_ranger','ngs_slayer', NULL),
  (44063,44007,1009,1,'https://youtu.be/565636fd64c7',N'trying_to_rid_this_name','ngs_gunner','ngs_ranger', NULL),

  (44064,44008,1014,0,'https://youtu.be/9832b6b4bf20',N'trying_to_rid_this_name','ngs_braver','ngs_hunter', NULL),
  (44065,44008,1005,0,NULL,N'trying_to_rid_this_name','ngs_waker','ngs_hunter', NULL),
  (44066,44008,1013,0,NULL,N'trying_to_rid_this_name','ngs_fighter','ngs_gunner', NULL),
  (44067,44008,1017,0,NULL,N'trying_to_rid_this_name','ngs_slayer','ngs_techter', NULL),
  (44068,44008,1003,1,NULL,N'trying_to_rid_this_name','ngs_gunner','ngs_force', NULL),
  (44069,44008,1006,1,NULL,N'trying_to_rid_this_name','ngs_waker','ngs_bouncer', NULL),
  (44070,44008,1025,1,NULL,N'trying_to_rid_this_name','ngs_braver','ngs_bouncer', NULL),
  (44071,44008,1024,1,NULL,N'trying_to_rid_this_name','ngs_force','ngs_techter', NULL),

  (44072,44009,1013,0,'https://youtu.be/444fdc11bb28',N'trying_to_rid_this_name','ngs_fighter','ngs_techter', NULL),
  (44073,44009,1012,0,NULL,N'trying_to_rid_this_name','ngs_braver','ngs_hunter', NULL),
  (44074,44009,5000000,0,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_gunner', NULL),
  (44075,44009,1006,0,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_fighter', NULL),
  (44076,44009,1015,1,NULL,N'trying_to_rid_this_name','ngs_hunter','ngs_force', NULL),
  (44077,44009,1007,1,NULL,N'trying_to_rid_this_name','ngs_slayer','ngs_force', NULL),
  (44078,44009,1016,1,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_fighter', NULL),
  (44079,44009,1011,1,NULL,N'trying_to_rid_this_name','ngs_braver','ngs_techter', NULL),

  (44080,44010,1015,0,'https://youtu.be/64d0d7b3a269',N'trying_to_rid_this_name','ngs_gunner','ngs_ranger', NULL),
  (44081,44010,1012,0,'https://youtu.be/80a2cfed5ec0',N'trying_to_rid_this_name','ngs_hunter','ngs_waker', NULL),
  (44082,44010,1007,0,'https://youtu.be/540b6dad2fdc',N'trying_to_rid_this_name','ngs_slayer','ngs_force', NULL),
  (44083,44010,1006,0,'https://youtu.be/8abacec6eecb',N'trying_to_rid_this_name','ngs_slayer','ngs_fighter', NULL),
  (44084,44010,1029,1,'https://youtu.be/b036216a0562',N'trying_to_rid_this_name','ngs_force','ngs_fighter', NULL),
  (44085,44010,1023,1,'https://youtu.be/9336a7d22216',N'trying_to_rid_this_name','ngs_ranger','ngs_bouncer', NULL),
  (44086,44010,1027,1,'https://youtu.be/4d7e86160f7d',N'trying_to_rid_this_name','ngs_techter','ngs_ranger', NULL),
  (44087,44010,1008,1,'https://youtu.be/d11ec9742160',N'trying_to_rid_this_name','ngs_ranger','ngs_fighter', NULL),

  (44088,44011,1014,0,'https://youtu.be/402b0684f4e2',N'trying_to_rid_this_name','ngs_gunner','ngs_braver', NULL),
  (44089,44011,1011,0,NULL,N'trying_to_rid_this_name','ngs_braver','ngs_gunner', NULL),
  (44090,44011,1007,0,'https://youtu.be/8cee01250f00',N'trying_to_rid_this_name','ngs_gunner','ngs_hunter', NULL),
  (44091,44011,1022,0,NULL,N'trying_to_rid_this_name','ngs_bouncer','ngs_braver', NULL),
  (44092,44011,1029,1,'https://youtu.be/3bd5b7236e00',N'trying_to_rid_this_name','ngs_slayer','ngs_ranger', NULL),
  (44093,44011,1015,1,NULL,N'trying_to_rid_this_name','ngs_techter','ngs_fighter', NULL),
  (44094,44011,1030,1,'https://youtu.be/78341233bfad',N'trying_to_rid_this_name','ngs_gunner','ngs_slayer', NULL),
  (44095,44011,1021,1,NULL,N'trying_to_rid_this_name','ngs_hunter','ngs_waker', NULL),

  (44096,44012,1017,0,'https://youtu.be/21309231a857',N'trying_to_rid_this_name','ngs_force','ngs_slayer', NULL),
  (44097,44012,1011,0,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_gunner', NULL),
  (44098,44012,1028,0,NULL,N'trying_to_rid_this_name','ngs_gunner','ngs_fighter', NULL),
  (44099,44012,1019,0,'https://youtu.be/d6c57691e0e5',N'trying_to_rid_this_name','ngs_force','ngs_waker', NULL),
  (44100,44012,1030,1,NULL,N'trying_to_rid_this_name','ngs_force','ngs_waker', NULL),
  (44101,44012,1018,1,'https://youtu.be/fb0e6d1e306f',N'trying_to_rid_this_name','ngs_braver','ngs_waker', NULL),
  (44102,44012,1003,1,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_braver', NULL),
  (44103,44012,1001,1,'https://youtu.be/57a545c540a6',N'trying_to_rid_this_name','ngs_waker','ngs_braver', NULL),

  (44104,44013,1016,0,'https://youtu.be/baefc7762fbc',N'trying_to_rid_this_name','ngs_gunner','ngs_slayer', NULL),
  (44105,44013,1013,0,'https://youtu.be/32fee6ebec56',N'trying_to_rid_this_name','ngs_bouncer','ngs_braver', NULL),
  (44106,44013,1025,0,'https://youtu.be/dd4e7562137f',N'trying_to_rid_this_name','ngs_fighter','ngs_hunter', NULL),
  (44107,44013,1004,0,'https://youtu.be/61d83b72e793',N'trying_to_rid_this_name','ngs_ranger','ngs_waker', NULL),
  (44108,44013,5000000,1,'https://youtu.be/b722da4a4e33',N'trying_to_rid_this_name','ngs_ranger','ngs_waker', NULL),
  (44109,44013,1011,1,'https://youtu.be/9d48bd9fa6b8',N'trying_to_rid_this_name','ngs_fighter','ngs_hunter', NULL),
  (44110,44013,1020,1,'https://youtu.be/c905a84ab7c2',N'trying_to_rid_this_name','ngs_bouncer','ngs_braver', NULL),
  (44111,44013,1009,1,'https://youtu.be/509989d42afa',N'trying_to_rid_this_name','ngs_fighter','ngs_slayer', NULL),

  (44112,44014,1011,0,'https://youtu.be/798ef453e6bd',N'trying_to_rid_this_name','ngs_bouncer','ngs_ranger', NULL),
  (44113,44014,1015,0,NULL,N'trying_to_rid_this_name','ngs_hunter','ngs_ranger', NULL),
  (44114,44014,1018,0,NULL,N'trying_to_rid_this_name','ngs_techter','ngs_bouncer', NULL),
  (44115,44014,1006,0,NULL,N'trying_to_rid_this_name','ngs_waker','ngs_techter', NULL),
  (44116,44014,1022,1,NULL,N'trying_to_rid_this_name','ngs_gunner','ngs_waker', NULL),
  (44117,44014,1029,1,NULL,N'trying_to_rid_this_name','ngs_hunter','ngs_ranger', NULL),
  (44118,44014,1030,1,NULL,N'trying_to_rid_this_name','ngs_waker','ngs_techter', NULL),
  (44119,44014,1021,1,NULL,N'trying_to_rid_this_name','ngs_slayer','ngs_techter', NULL),

  (44120,44015,1012,0,'https://youtu.be/bb533de095fb',N'trying_to_rid_this_name','ngs_slayer','ngs_techter', NULL),
  (44121,44015,1001,0,'https://youtu.be/b1dc74f87d69',N'trying_to_rid_this_name','ngs_hunter','ngs_ranger', NULL),
  (44122,44015,1007,0,'https://youtu.be/fff011d348d6',N'trying_to_rid_this_name','ngs_fighter','ngs_bouncer', NULL),
  (44123,44015,1010,0,'https://youtu.be/bea1ebb08b91',N'trying_to_rid_this_name','ngs_ranger','ngs_force', NULL),
  (44124,44015,1008,1,'https://youtu.be/00f119f1cc9c',N'trying_to_rid_this_name','ngs_bouncer','ngs_ranger', NULL),
  (44125,44015,1023,1,'https://youtu.be/0752941f3684',N'trying_to_rid_this_name','ngs_fighter','ngs_techter', NULL),
  (44126,44015,1022,1,'https://youtu.be/c9fe0cc641d4',N'trying_to_rid_this_name','ngs_fighter','ngs_slayer', NULL),
  (44127,44015,1021,1,'https://youtu.be/0b684e872c27',N'trying_to_rid_this_name','ngs_ranger','ngs_fighter', NULL),

  (44128,44016,1012,0,'https://youtu.be/171f7f08ea7a',N'trying_to_rid_this_name','ngs_techter','ngs_ranger', NULL),
  (44129,44016,1023,0,'https://youtu.be/e4f24570d95b',N'trying_to_rid_this_name','ngs_gunner','ngs_braver', NULL),
  (44130,44016,1030,0,'https://youtu.be/e30e875ed34c',N'trying_to_rid_this_name','ngs_gunner','ngs_braver', NULL),
  (44131,44016,5000000,0,'https://youtu.be/0f1fea721dc0',N'trying_to_rid_this_name','ngs_ranger','ngs_braver', NULL),
  (44132,44016,1006,1,'https://youtu.be/2963c6e9ffa0',N'trying_to_rid_this_name','ngs_braver','ngs_slayer', NULL),
  (44133,44016,1004,1,'https://youtu.be/3a10ec30553a',N'trying_to_rid_this_name','ngs_gunner','ngs_techter', NULL),
  (44134,44016,1018,1,'https://youtu.be/e579369f8a46',N'trying_to_rid_this_name','ngs_waker','ngs_force', NULL),
  (44135,44016,1008,1,'https://youtu.be/6e1b8e2adb5a',N'trying_to_rid_this_name','ngs_gunner','ngs_hunter', NULL),

  (44136,44017,5000000,0,'https://youtu.be/77887d49574a',N'trying_to_rid_this_name','ngs_bouncer','ngs_braver', NULL),
  (44137,44017,1001,0,'https://youtu.be/ecc7153b72ed',N'trying_to_rid_this_name','ngs_hunter','ngs_slayer', NULL),
  (44138,44017,1005,0,'https://youtu.be/df6358782323',N'trying_to_rid_this_name','ngs_force','ngs_gunner', NULL),
  (44139,44017,1020,0,'https://youtu.be/79a7d4dbe765',N'trying_to_rid_this_name','ngs_hunter','ngs_slayer', NULL),
  (44140,44017,1013,1,'https://youtu.be/45bbe124b1e2',N'trying_to_rid_this_name','ngs_gunner','ngs_waker', NULL),
  (44141,44017,1028,1,'https://youtu.be/3a8c91d786a6',N'trying_to_rid_this_name','ngs_techter','ngs_bouncer', NULL),
  (44142,44017,1017,1,'https://youtu.be/ca5cec065e1e',N'trying_to_rid_this_name','ngs_hunter','ngs_ranger', NULL),
  (44143,44017,1010,1,'https://youtu.be/fe4b0c939ae6',N'trying_to_rid_this_name','ngs_force','ngs_slayer', NULL),

  (44144,44018,5000000,0,'https://youtu.be/7c3e953269f6',N'trying_to_rid_this_name','ngs_techter','ngs_hunter', NULL),
  (44145,44018,1019,0,'https://youtu.be/dddfaaeb80ea',N'trying_to_rid_this_name','ngs_gunner','ngs_ranger', NULL),
  (44146,44018,1012,0,'https://youtu.be/faed458f01c4',N'trying_to_rid_this_name','ngs_ranger','ngs_gunner', NULL),
  (44147,44018,1022,0,NULL,N'trying_to_rid_this_name','ngs_bouncer','ngs_techter', NULL),
  (44148,44018,1016,1,NULL,N'trying_to_rid_this_name','ngs_bouncer','ngs_hunter', NULL),
  (44149,44018,1002,1,NULL,N'trying_to_rid_this_name','ngs_ranger','ngs_hunter', NULL),
  (44150,44018,1001,1,NULL,N'trying_to_rid_this_name','ngs_bouncer','ngs_ranger', NULL),
  (44151,44018,1017,1,'https://youtu.be/40dce2873949',N'trying_to_rid_this_name','ngs_waker','ngs_gunner', NULL),

  (44152,44019,5000000,0,'https://youtu.be/b6c370e2985e',N'trying_to_rid_this_name','ngs_braver','ngs_force', NULL),
  (44153,44019,1005,0,'https://youtu.be/dc2b42927ab3',N'trying_to_rid_this_name','ngs_force','ngs_techter', NULL),
  (44154,44019,1010,0,'https://youtu.be/f04ac0c21a80',N'trying_to_rid_this_name','ngs_waker','ngs_gunner', NULL),
  (44155,44019,1006,0,'https://youtu.be/b19415697643',N'trying_to_rid_this_name','ngs_fighter','ngs_gunner', NULL),
  (44156,44019,1028,1,'https://youtu.be/7fbc63ac4855',N'trying_to_rid_this_name','ngs_fighter','ngs_force', NULL),
  (44157,44019,1019,1,'https://youtu.be/153c6687c347',N'trying_to_rid_this_name','ngs_slayer','ngs_force', NULL),
  (44158,44019,1029,1,'https://youtu.be/7afcbf47427f',N'trying_to_rid_this_name','ngs_waker','ngs_braver', NULL),
  (44159,44019,1021,1,'https://youtu.be/5b938cf1d109',N'trying_to_rid_this_name','ngs_slayer','ngs_force', NULL)
;
SET IDENTITY_INSERT [dbo].[RunParty] OFF;