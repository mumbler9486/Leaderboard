...
VALUES
  (1000,1001,'ngs','purples','aelio','global','level80r',4,1,'0:12:55','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1001,1017,'ngs','purples','aelio','japan','level80r',4,1,'0:15:01','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1002,1011,'ngs','purples','aelio','global','60r',4,1,'0:17:47','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1003,1013,'ngs','purples','aelio','global','pre60r',4,1,'0:18:16','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1004,1001,'ngs','purples','aelio','global','pot6r',4,1,'0:16:51','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1005,1011,'ngs','purples','aelio','japan','pre60r',4,1,'0:10:54','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1006,1012,'ngs','purples','aelio','global','level75r',3,1,'0:17:21','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1007,1013,'ngs','purples','aelio','global','lvl80grind',3,1,'0:15:53','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1008,1014,'ngs','purples','aelio','japan','60r',3,1,'0:14:15','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1009,1013,'ngs','purples','aelio','japan','60r',2,1,'0:13:41','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1010,1015,'ngs','purples','aelio','global','pre60r',2,1,'0:17:24','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1011,1014,'ngs','purples','aelio','japan','level75r',2,1,'0:18:37','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1012,1017,'ngs','purples','aelio','global','level75r',1,1,'0:17:21','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1013,1016,'ngs','purples','aelio','global','level80r',1,1,'0:13:39','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1014,1011,'ngs','purples','aelio','global','60r',1,1,'0:19:36','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1015,1012,'ngs','purples','aelio','global','pre60r',4,1,'0:15:39','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool');
...
OVERRIDING SYSTEM VALUE
VALUES
  (1100,1001,'ngs','purples','aelio','global','level80r',4,2,'0:12:55','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1101,1017,'ngs','purples','aelio','japan','level80r',4,2,'0:15:01','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1102,1011,'ngs','purples','aelio','global','60r',4,2,'0:17:47','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1103,1013,'ngs','purples','aelio','global','pre60r',4,2,'0:18:16','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1104,1001,'ngs','purples','aelio','global','pot6r',4,2,'0:16:51','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1105,1011,'ngs','purples','aelio','japan','pre60r',4,2,'0:10:54','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1106,1012,'ngs','purples','aelio','global','level75r',3,2,'0:17:21','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1107,1013,'ngs','purples','aelio','global','lvl80grind',3,2,'0:15:53','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1108,1014,'ngs','purples','aelio','japan','60r',3,2,'0:14:15','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1109,1013,'ngs','purples','aelio','japan','60r',2,2,'0:13:41','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1110,1015,'ngs','purples','aelio','global','pre60r',2,2,'0:17:24','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1111,1014,'ngs','purples','aelio','japan','level75r',2,2,'0:18:37','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1112,1017,'ngs','purples','aelio','global','level75r',1,2,'0:17:21','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1113,1016,'ngs','purples','aelio','global','level80r',1,2,'0:13:39','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1114,1011,'ngs','purples','aelio','global','60r',1,2,'0:19:36','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1115,1012,'ngs','purples','aelio','global','pre60r',4,2,'0:15:39','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool');
INSERT INTO run_party
  (id,run_id,player_id,ordinal,pov_link,run_character_name,main_class,sub_class,weapons)
OVERRIDING SYSTEM VALUE
VALUES
...
OVERRIDING SYSTEM VALUE
VALUES
  (1200,1001,'ngs','purples','aelio','global','level80r',4,4,'0:12:55','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1201,1017,'ngs','purples','aelio','japan','level80r',4,4,'0:15:01','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1202,1011,'ngs','purples','aelio','global','60r',4,4,'0:17:47','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1203,1013,'ngs','purples','aelio','global','pre60r',4,4,'0:18:16','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1204,1001,'ngs','purples','aelio','global','pot6r',4,4,'0:16:51','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1205,1011,'ngs','purples','aelio','japan','pre60r',4,4,'0:10:54','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1206,1012,'ngs','purples','aelio','global','level75r',3,4,'0:17:21','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1207,1013,'ngs','purples','aelio','global','lvl80grind',3,4,'0:15:53','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1208,1014,'ngs','purples','aelio','japan','60r',3,4,'0:14:15','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1209,1013,'ngs','purples','aelio','japan','60r',2,4,'0:13:41','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1210,1015,'ngs','purples','aelio','global','pre60r',2,4,'0:17:24','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1211,1014,'ngs','purples','aelio','japan','level75r',2,4,'0:18:37','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1212,1017,'ngs','purples','aelio','global','level75r',1,4,'0:17:21','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1213,1016,'ngs','purples','aelio','global','level80r',1,4,'0:13:39','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1214,1011,'ngs','purples','aelio','global','60r',1,4,'0:19:36','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool'),
  (1215,1012,'ngs','purples','aelio','global','pre60r',4,4,'0:15:39','Notes',CURRENT_DATE,1, CURRENT_DATE,'Mod Notes', NULL,'Tall Mommy Cool');
INSERT INTO run_party
  (id,run_id,player_id,ordinal,pov_link,run_character_name,main_class,sub_class,weapons)
OVERRIDING SYSTEM VALUE
VALUES
...
select setval(pg_get_serial_sequence('runs', 'id'), coalesce(MAX(id), 1) +1) 
FROM runs;
SELECT MAX(Id) FROM runs;

select setval(pg_get_serial_sequence('run_party', 'id'), coalesce(MAX(id), 1) +1) 
FROM run_party;
SELECT MAX(Id) FROM runs;