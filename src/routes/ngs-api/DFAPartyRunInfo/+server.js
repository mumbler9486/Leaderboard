...
export async function GET({ url }) {
	...
	try {
        ...
        INNER JOIN
        DFAegis.PartyRunners as runPlayers ON run.RunID = runPlayers.RunID
        INNER JOIN
        ...
        returner.forEach(data => {
            var dataReturn = {
                ...
                p5: {
                    ...
                    LinkPOV: data.LinkPOV.split('-coalesce|string|agg-')[4] == 'partynull' ? null : data.LinkPOV.split('-coalesce|string|agg-')[4],
                    Server: data.Server.split('-coalesce|string|agg-')[4] == 'partynull' ? null : data.Server.split('-coalesce|string|agg-')[4],
                    Ship: data.Ship.split('-coalesce|string|agg-')[4] == '99' ? null : data.Ship.split('-coalesce|string|agg-')[4],
                    Flag: data.Flag.split('-coalesce|string|agg-')[4] == 'partynull' ? null : data.Flag.split('-coalesce|string|agg-')[4],
                ...
                p6: {
                    ...
                    LinkPOV: data.LinkPOV.split('-coalesce|string|agg-')[5] == 'partynull' ? null : data.LinkPOV.split('-coalesce|string|agg-')[5],
                    Server: data.Server.split('-coalesce|string|agg-')[5] == 'partynull' ? null : data.Server.split('-coalesce|string|agg-')[5],
                    Ship: data.Ship.split('-coalesce|string|agg-')[5] == '99' ? null : data.Ship.split('-coalesce|string|agg-')[5],
                    Flag: data.Flag.split('-coalesce|string|agg-')[5] == 'partynull' ? null : data.Flag.split('-coalesce|string|agg-')[5],
                ...
                p7: {
                    ...
                    LinkPOV: data.LinkPOV.split('-coalesce|string|agg-')[6] == 'partynull' ? null : data.LinkPOV.split('-coalesce|string|agg-')[6],
                    Server: data.Server.split('-coalesce|string|agg-')[6] == 'partynull' ? null : data.Server.split('-coalesce|string|agg-')[6],
                    Ship: data.Ship.split('-coalesce|string|agg-')[6] == '99' ? null : data.Ship.split('-coalesce|string|agg-')[6],
                    Flag: data.Flag.split('-coalesce|string|agg-')[6] == 'partynull' ? null : data.Flag.split('-coalesce|string|agg-')[6],
                ...
                p8: {
                    ...
                    LinkPOV: data.LinkPOV.split('-coalesce|string|agg-')[7] == 'partynull' ? null : data.LinkPOV.split('-coalesce|string|agg-')[7],
                    Server: data.Server.split('-coalesce|string|agg-')[7] == 'partynull' ? null : data.Server.split('-coalesce|string|agg-')[7],
                    Ship: data.Ship.split('-coalesce|string|agg-')[7] == '99' ? null : data.Ship.split('-coalesce|string|agg-')[7],
                    Flag: data.Flag.split('-coalesce|string|agg-')[7] == 'partynull' ? null : data.Flag.split('-coalesce|string|agg-')[7],
