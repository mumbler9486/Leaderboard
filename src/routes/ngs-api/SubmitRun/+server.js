...
const regionList = ["aelio", "retem", "kvaris", "stia"];
...
export async function POST({ request }) {
  ...
  for (let i = 0; i < Number(data.PartySize); i++) {
    ...
    if (
      data.Trigger &&
      Number(data.Trigger) != 1 &&
      Number(data.Trigger) != 0
    ) {
    ...
    if (
      data["Player" + (i + 1)].Server != "global" &&
      data["Player" + (i + 1)].Server != "japan"
    ) {
      return json({ Code: "error" });
    }
    ...
    if (
      data["Player" + (i + 1)].Video != null &&
      data["Player" + (i + 1)].Video != ""
    ) {
      var urls = [data["Player" + (i + 1)].Video];
    ...
    switch (data.RunType) {
      case "purple":
        ...
        if (Number(data.PartySize) == 4) {
          ...
          results = await pool
            .request()
            .input("uid", sql.NVarChar, data.SubmitterID)
            .query(sqlQuery);
         ...
         */
          ...
          var results = await pool
            .request()
            .input("Link", sql.NVarChar, data["Player1"].Video)
            .query(sqlQuery);
          ...
          data["Player1"].Weapons[0] == null ||
          data["Player1"].Weapons[0] == undefined
            ? data["Player1"].Weapons[0] == ""
            : null;
          data["Player1"].Weapons[1] == null ||
          data["Player1"].Weapons[1] == undefined
            ? data["Player1"].Weapons[1] == ""
            : null;
          data["Player1"].Weapons[2] == null ||
          data["Player1"].Weapons[2] == undefined
            ? data["Player1"].Weapons[2] == ""
            : null;
          data["Player1"].Weapons[3] == null ||
          data["Player1"].Weapons[3] == undefined
            ? data["Player1"].Weapons[3] == ""
            : null;
          data["Player1"].Weapons[4] == null ||
          data["Player1"].Weapons[4] == undefined
            ? data["Player1"].Weapons[4] == ""
            : null;
          data["Player1"].Weapons[5] == null ||
          data["Player1"].Weapons[5] == undefined
            ? data["Player1"].Weapons[5] == ""
            : null;
          ...
          await pool
            .request()
            .input("0", sql.Int, data["Player1"].PlayerID)
            .input("1", sql.NVarChar, data["Player1"].VideoName)
            .input("2", sql.NVarChar, "60R")
            .input("3", sql.NVarChar, data.Region)
            .input("4", sql.Int, data.Rank)
            .input("5", sql.NVarChar, data.Time)
            .input("6", sql.NVarChar, data["Player1"].MainClass)
            .input("7", sql.NVarChar, data["Player1"].SubClass)
            .input("8", sql.NVarChar, data["Player1"].Weapons[0])
            .input("9", sql.NVarChar, data["Player1"].Weapons[1])
            .input("10", sql.NVarChar, data["Player1"].Weapons[2])
            .input("11", sql.NVarChar, data["Player1"].Weapons[3])
            .input("12", sql.NVarChar, data["Player1"].Weapons[4])
            .input("13", sql.NVarChar, data["Player1"].Weapons[5])
            .input("14", sql.NVarChar, data["Player1"].Video)
            .input("15", sql.NVarChar, data.Notes)
            .input("16", sql.DateTime, date)
            .input("17", sql.Int, data.SubmitterID)
            .query(sqlQuery);
      ...
      case "aegis":
         ...
         */
          ...
          await pool
            ...
            .input("1", sql.NVarChar, data["Player1"].VideoName)
            .input("2", sql.NVarChar, "60R")
            .input("3", sql.Int, data.Trigger)
            .input("4", sql.NVarChar, data.Buff)
            .input("5", sql.NVarChar, data.Time)
            .input("6", sql.NVarChar, data["Player1"].MainClass)
            .input("7", sql.NVarChar, data["Player1"].SubClass)
            .input("8", sql.NVarChar, data["Player1"].Weapons[0])
