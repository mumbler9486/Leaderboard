		...
		switch (data.RunType) {
			case 'purple':
				...
				if (Number(data.PartySize) == 2) {
					...
					data['Player1'].Weapons[0] == null || data['Player1'].Weapons[0] == undefined
						? data['Player1'].Weapons[0] == ''
						: null;
					data['Player1'].Weapons[1] == null || data['Player1'].Weapons[1] == undefined
						? data['Player1'].Weapons[1] == ''
						: null;
					data['Player1'].Weapons[2] == null || data['Player1'].Weapons[2] == undefined
						? data['Player1'].Weapons[2] == ''
						: null;
					data['Player1'].Weapons[3] == null || data['Player1'].Weapons[3] == undefined
						? data['Player1'].Weapons[3] == ''
						: null;
					data['Player1'].Weapons[4] == null || data['Player1'].Weapons[4] == undefined
						? data['Player1'].Weapons[4] == ''
						: null;
					data['Player1'].Weapons[5] == null || data['Player1'].Weapons[5] == undefined
