    ...
    case "dfaduo":
      try {
        ...
        await poolConnection
          .request()
          .input("0", sql.Int, data.shared.RunID)
          .query(sqlRemove);
        ...
        var identity = await poolConnection
          .request()
    ...
    case "dfasolo":
      try {
        ...
        var testexisting = await poolConnection
          .request()
          .input("Player", sql.Int, data.PlayerID)
          .input("Region", sql.NVarChar, data.Support)
          .input("Rank", sql.Int, data.Drill)
          .input("Patch", sql.NVarChar, data.Patch)
          .input("Main", sql.NVarChar, data.MainClass)
          .input("Sub", sql.NVarChar, data.SubClass)
          .input("w1", sql.NVarChar, data.W1)
          .input("w2", sql.NVarChar, data.W2)
          .input("w3", sql.NVarChar, data.W3)
          .input("w4", sql.NVarChar, data.W4)
          .input("w5", sql.NVarChar, data.W5)
          .input("w6", sql.NVarChar, data.W6)
          .query(sqlRemove);

        if (
          testexisting.rowsAffected != 0 &&
          testexisting.recordset[0].PlayerID != 106 &&
          testexisting.recordset[0].PlayerID != 107
        ) {
          ...
          await poolConnection
            .request()
            .input("7", sql.NVarChar, data.Time)
            .input("0", sql.Int, testexisting.recordset[0].RunID)
            .input("1", sql.NVarChar, data.RunCharacter)
            .input("2", sql.NVarChar, data.Link)
            .input("3", sql.NVarChar, data.Notes)
            .input("4", sql.DateTime, data.SubmissionTime)
            .input("5", sql.Int, data.SubmitterID)
            .input("6", sql.NVarChar, data.ModNotes)
            .query(sqlUpdate);
        } else {
          ...
          await poolConnection
            .request()
            .input("1", sql.Int, data.PlayerID)
            .input("2", sql.NVarChar, data.RunCharacter)
            .input("3", sql.NVarChar, data.Patch)
            .input("4", sql.NVarChar, data.Support)
            .input("5", sql.Int, data.Drill)
            .input("6", sql.NVarChar, data.Time)
            .input("7", sql.NVarChar, data.MainClass)
            .input("8", sql.NVarChar, data.SubClass)
            .input("9", sql.NVarChar, data.W1)
            .input("10", sql.NVarChar, data.W2)
            .input("11", sql.NVarChar, data.W3)
            .input("12", sql.NVarChar, data.W4)
            .input("13", sql.NVarChar, data.W5)
            .input("14", sql.NVarChar, data.W6)
            .input("15", sql.NVarChar, data.Link)
            .input("16", sql.NVarChar, data.Notes)
            .input("17", sql.DateTime, data.SubmissionTime)
            .input("18", sql.Int, data.SubmitterID)
            .input("19", sql.NVarChar, data.ModNotes)
            .query(sqlQuery);
        }
      ...
      try {
        ...
        if (
          ...
          await poolConnection
            ...
            .input("2", sql.NVarChar, data.RunCharacter)
            .input("3", sql.NVarChar, data.Patch)
            .input("4", sql.NVarChar, data.Region)
            .input("5", sql.Int, data.Rank)
            .input("6", sql.NVarChar, data.Time)
            .input("7", sql.NVarChar, data.MainClass)
            .input("8", sql.NVarChar, data.SubClass)
            .input("9", sql.NVarChar, data.W1)
