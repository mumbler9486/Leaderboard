			...
			<ul class="list-disc">
				...
				<li>
					<p>
						...
						Agreement) refers to PSO2 Central.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						...
						<a
							...
							target="_blank">Free Terms and Conditions Generator</a
						>.
					</p>
				</li>
				<li>
				...
				<li>
					<p>
						<strong>Website</strong> refers to PSO2 Central, accessible from
						<a href="https://pso2central.com" rel="external nofollow noopener" target="_blank"
							>https://pso2central.com</a
						>
					</p>
				</li>
				<li>
