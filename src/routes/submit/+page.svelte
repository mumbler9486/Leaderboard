	...
	function testValue(i) {
		if (
			document
				...
				.options.namedItem(
					''.concat(
						document.getElementById('playername-form' + (i + 1)).value.toString(),
						(i + 1).toString()
					)
				) == null
		) {
								...
								<div class="m-2 gap-1 rounded-md border border-secondary bg-secondary/10 p-4 px-8">
									...
									<div class="grid grid-cols-1 gap-2 md:grid-cols-3">
										<div class="form-control">
											...
											<label class="label">
												<span class="label-text-alt"
													>You can search for existing players by player and character name!<br
											...
											<datalist id={'playerName-datalist' + (i + 1)}>
												{#each userList as user}
													<option
														...
														data-player={user.PlayerID}>{user.CharacterName}</option
													>
												{/each}
											</datalist>
										</div>
										...
										<div class="form-control">
											...
											<label class="label">
												<span class="label-text-alt"
													>This is required to help viewers determine who is playing who in
													situations where Player/Main Character Name doesn't match the In-Video
													Character Name.<br /><span class="text-warning"
														>Even if the In-Video Character Name is the same as the Main Character
														or Player Name, you must still enter it here.</span
													></span
												>
											</label>
										</div>
										...
										<div class="form-control">
											...
											<select id={'playerserver-form' + (i + 1)} class="select-bordered select">
												<option value="global" selected>Global</option>
												<option value="japan">Japan</option>
											</select>
											<label class="label">
												<span class="label-text-alt text-warning"
													>This only applies to manual name entries! If you picked an existing
													player, ignore this!</span
												>
											</label>
										</div>
									</div>

									<div class="my-4 text-center text-lg font-semibold">Main Class</div>
									...
									<div class="my-4 text-center text-lg font-semibold">Sub Class</div>
									...
									<div class="my-4 text-center text-lg font-semibold">Video</div>
									...
									<div class="grid grid-cols-1 gap-2">
										<div class="form-control">
											...
											<label class="label">
												<span class="label-text-alt"
													>Accepts any youtube link. (youtube.com, youtu.be...)<br /><span
														class="text-warning">Additional site support coming soon!</span
													></span
												>
											</label>
										</div>
