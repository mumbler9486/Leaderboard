<script>
  ...
  function changeCategory() {
    selectedCategoryRuns = document.getElementById(
      "runselectiontype-form"
    ).value;
  }
</script>
  ...
  <div class="flex grow flex-col content-center">
    ...
    >
      ...
      >
        ...
        <div
          class="m-0 gap-1 rounded-md border border-secondary bg-secondary/10 p-4 px-8 md:m-2"
        >
          <div class="flex flex-col gap-2 md:flex-row">
            <div class="form-control grow">
              ...
              >
                <option value="purplesolo" selected
                  >Purple Triggers - Solo</option
                >
