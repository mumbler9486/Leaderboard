<script lang="ts">
  ...
  function testValue(i) {
    if (
      document
        .getElementById("playerName-datalist" + (i + 1))
        .options.namedItem(
          "".concat(
            document
              .getElementById("playername-form" + (i + 1))
              .value.toString(),
            (i + 1).toString()
          )
        ) == null
  ...
  function updateWeaponChoice() {
    if (
      (selectedWeapons.length > 6 && Number(selectedPartySize) == 1) ||
      (selectedWeapons.length == 0 && Number(selectedPartySize) == 1)
    ) {
  ...
  async function submitRun() {
    ...
    Number(input.PartySize) > 1
      ? (input.RunServer = document.getElementById("runserver-form").value)
      : null;
    ...
    for (let i = 0; i < Number(input.PartySize); i++) {
      ...
      if (
        ...
        input["Player" + (i + 1)].PlayerID = document
          .getElementById("playerName-datalist" + (i + 1))
          .options.namedItem(
            "".concat(
              document
      ...
      input["Player" + (i + 1)].Name = document.getElementById(
        "playername-form" + (i + 1)
      ).value;
      input["Player" + (i + 1)].VideoName = document.getElementById(
        "charactername-form" + (i + 1)
      ).value;
      input["Player" + (i + 1)].Server = document.getElementById(
        "playerserver-form" + (i + 1)
      ).value;
      input["Player" + (i + 1)].MainClass = document.querySelector(
        'input[name="radio-mainclass' + (i + 1) + '"]:checked'
      ).value;
      input["Player" + (i + 1)].SubClass = document.querySelector(
        'input[name="radio-subclass' + (i + 1) + '"]:checked'
      ).value;
      ...
      input["Player" + (i + 1)].Video = document.getElementById(
        "video-form" + (i + 1)
      ).value;
    }
...
<div class="flex min-h-screen flex-col">
  ...
  <div class="flex grow flex-col content-center">
    <div
      class="container m-16 mx-auto flex grow rounded-md border border-secondary bg-base-100/75"
    >
      <div
      ...
      >
        ...
        {:else if submitted}
          <div
            class="flex basis-full flex-col place-content-center place-items-center gap-1"
          >
            Your run has been submitted and will be reviewed as soon as
            possible!<br /><a class="link-primary link" href="/"
        ...
        {:else}
          <form id="submitForm" on:submit={submitRun}>
            <div
              class="m-2 gap-1 rounded-md border border-secondary bg-secondary/10 p-4 px-8"
            >
              ...
              <div class="form-control">
                ...
                <select
                  ...
                  required
                  on:change={updateCategoryChoice}
                >
              ...
              {#if selectedCategory}
                <div class="form-control">
                  ...
                  <select
                    ...
                    class="select-bordered select"
                    required
                    on:change={updatePartySizeChoice}
                  >
                    <option value="" disabled selected
                      >Select a Party Size...</option
                    >
              ...
              {#if selectedCategory && selectedCategory == "purple"}
                <div class="grid grid-cols-1 gap-2 md:grid-cols-3">
                  <div class="form-control">
                    ...
                    <select
                      name="regionselect"
                      id="regionselect-form"
                      class="select-bordered select"
                      required
                      on:change={updateRegionChoice}
                    >
                      <option value="" disabled selected
                  ...
                  <div class="form-control">
                    ...
                    <label class="label">
                      <span class="label-text"
                        >This is the total time taken on your run.<br /><span
                          class="text-warning"
              ...
              {:else if selectedCategory && selectedCategory == "aegis"}
                <div class="grid grid-cols-1 gap-2 md:grid-cols-3">
                  ...
                  <div class="form-control">
                    ...
                    <label class="label">
                      <span class="label-text"
                        >This is the time shown at the end of the quest.</span
                      >
                    </label>
                  </div>
                </div>
              ...
              {#if selectedPartySize && Number(selectedPartySize) > 1}
                <div class="form-control">
                  ...
                  <select id="runserver-form" class="select-bordered select">
                    <option value="global" selected>Global</option>
                    <option value="japan">Japan</option>
                  </select>
                  <label class="label">
                    <span class="label-text-alt"
                      >This is the server the run was recorded on.</span
                    >
                  </label>
                </div>
              {/if}
            ...
            {#if selectedCategory && selectedPartySize}
              {#each { length: Number(selectedPartySize) } as _, i}
                ...
                >
                  ...
                  {:else}
                    <div class="text-center text-xl font-semibold">Player</div>
                  {/if}
                  ...
                  <div class="grid grid-cols-1 gap-2 md:grid-cols-3">
                    <div class="form-control">
                      ...
                      <input
                        ...
                        list={"playerName-datalist" + (i + 1)}
                        id={"playername-form" + (i + 1)}
                        name={"player-name-form" + (i + 1)}
                        class="input-bordered input"
                        required
                        on:change={() => testValue(i)}
                      />
                      <label class="label">
                        <span class="label-text-alt"
                          >You can search for existing players by player and
                          character name!<br /><span class="text-warning"
                            >Please keep in mind that this list is sorted by
                            Player Name.</span
                          ></span
                        >
                      </label>
                      <datalist id={"playerName-datalist" + (i + 1)}>
                        {#each userList as user}
                          <option
                            id={user.PlayerName + (i + 1)}
                            value={user.PlayerName}
                            data-player={user.PlayerID}
                            >{user.CharacterName}</option
                          >
                        {/each}
                      </datalist>
                    </div>
                    ...
                    <div class="form-control">
                      ...
                      <label class="label">
                        <span class="label-text-alt"
                          >This is required to help viewers determine who is
                          playing who in situations where Player/Main Character
                          Name doesn't match the In-Video Character Name.<br
                          /><span class="text-warning"
                            >Even if the In-Video Character Name is the same as
                            the Main Character or Player Name, you must still
                            enter it here.</span
                          ></span
                        >
                      </label>
                    ...
                    <div class="form-control">
                      ...
                      <label class="label">
                        <span class="label-text-alt text-warning"
                          >This only applies to manual name entries! If you
                          picked an existing player, ignore this!</span
                        >
                      </label>
                    </div>
                  </div>

                  <div class="my-4 text-center text-lg font-semibold">
                    Main Class
                  </div>
                  ...
                  <div class="grid grid-cols-1 gap-2 md:grid-cols-5">
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="hunter"
                          type="radio"
                          id={"form-radio-mainclass-hunter" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                      </label>
                    ...
                    <div class="form-control">
                      ...
                      >
                        <img
                          src="/icons/class/class-fighter.png"
                          alt="Fighter"
                        />
                        ...
                        <input
                          value="fighter"
                          type="radio"
                          id={"form-radio-mainclass-fighter" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="ranger"
                          type="radio"
                          id={"form-radio-mainclass-ranger" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="gunner"
                          type="radio"
                          id={"form-radio-mainclass-gunner" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="force"
                          type="radio"
                          id={"form-radio-mainclass-force" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        <img
                          src="/icons/class/class-techter.png"
                          alt="Techter"
                        />
                        ...
                        <input
                          value="techter"
                          type="radio"
                          id={"form-radio-mainclass-techter" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="braver"
                          type="radio"
                          id={"form-radio-mainclass-braver" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        <img
                          src="/icons/class/class-bouncer.png"
                          alt="Bouncer"
                        />
                        ...
                        <input
                          value="bouncer"
                          type="radio"
                          id={"form-radio-mainclass-bouncer" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="waker"
                          type="radio"
                          id={"form-radio-mainclass-waker" + (i + 1)}
                          name={"radio-mainclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="hunter"
                          type="radio"
                          id={"form-radio-subclass-hunter" + (i + 1)}
                          name={"radio-subclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                      </label>
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="ranger"
                          type="radio"
                          id={"form-radio-subclass-ranger" + (i + 1)}
                          name={"radio-subclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="gunner"
                          type="radio"
                          id={"form-radio-subclass-gunner" + (i + 1)}
                          name={"radio-subclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="force"
                          type="radio"
                          id={"form-radio-subclass-force" + (i + 1)}
                          name={"radio-subclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="techter"
                          type="radio"
                          id={"form-radio-subclass-techter" + (i + 1)}
                          name={"radio-subclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="braver"
                          type="radio"
                          id={"form-radio-subclass-braver" + (i + 1)}
                          name={"radio-subclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="bouncer"
                          type="radio"
                          id={"form-radio-subclass-bouncer" + (i + 1)}
                          name={"radio-subclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                    ...
                    <div class="form-control">
                      ...
                      >
                        ...
                        <input
                          value="waker"
                          type="radio"
                          id={"form-radio-subclass-waker" + (i + 1)}
                          name={"radio-subclass" + (i + 1)}
                          class="radio rounded"
                          required
                        />
                  ...
                  {#if Number(selectedPartySize) === 1}
                    ...
                    <div class="mb-4 text-center text-warning">
                      Maximum of 6
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-2 md:grid-cols-5">
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-sword.png"
                            alt="Sword"
                          />
                          <span class="label-text">Sword</span>
                          <input
                            bind:group={selectedWeapons}
                            on:change={updateWeaponChoice}
                            value="sword"
                            type="checkbox"
                            id={"form-checkbox-weapon-sword" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-wire.png"
                            alt="Wired Lance"
                          />
                          ...
                          <input
                            ...
                            value="wl"
                            type="checkbox"
                            id={"form-checkbox-weapon-wl" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-partisan.png"
                            alt="Partisan"
                          />
                          ...
                          <input
                            ...
                            value="partisan"
                            type="checkbox"
                            id={"form-checkbox-weapon-partisan" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-daggers.png"
                            alt="Twin Daggers"
                          />
                          ...
                          <input
                            ...
                            value="td"
                            type="checkbox"
                            id={"form-checkbox-weapon-td" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-saber.png"
                            alt="Double Saber"
                          />
                          ...
                          <input
                            ...
                            value="ds"
                            type="checkbox"
                            id={"form-checkbox-weapon-ds" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-knux.png"
                            alt="Knuckles"
                          />
                          ...
                          <input
                            ...
                            value="knuckles"
                            type="checkbox"
                            id={"form-checkbox-weapon-knuckles" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-katana.png"
                            alt="Katana"
                          />
                          ...
                          <input
                            ...
                            value="katana"
                            type="checkbox"
                            id={"form-checkbox-weapon-katana" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-blades.png"
                            alt="Soaring Blades"
                          />
                          ...
                          <input
                            ...
                            value="sb"
                            type="checkbox"
                            id={"form-checkbox-weapon-sb" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-rifle.png"
                            alt="Assault Rifle"
                          />
                          ...
                          <input
                            ...
                            value="rifle"
                            type="checkbox"
                            id={"form-checkbox-weapon-rifle" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-launcher.png"
                            alt="Launcher"
                          />
                          ...
                          <input
                            ...
                            value="launcher"
                            type="checkbox"
                            id={"form-checkbox-weapon-launcher" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-tmg.png"
                            alt="Twin Machine Guns"
                          />
                          ...
                          <input
                            ...
                            value="tmg"
                            type="checkbox"
                            id={"form-checkbox-weapon-tmg" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          ...
                          <input
                            ...
                            value="bow"
                            type="checkbox"
                            id={"form-checkbox-weapon-bow" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          ...
                          <input
                            ...
                            value="rod"
                            type="checkbox"
                            id={"form-checkbox-weapon-rod" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-talis.png"
                            alt="Talis"
                          />
                          ...
                          <input
                            ...
                            value="talis"
                            type="checkbox"
                            id={"form-checkbox-weapon-talis" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          ...
                          <input
                            ...
                            value="wand"
                            type="checkbox"
                            id={"form-checkbox-weapon-wand" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-boots.png"
                            alt="Jet Boots"
                          />
                          ...
                          <input
                            ...
                            value="jb"
                            type="checkbox"
                            id={"form-checkbox-weapon-jb" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                      ...
                      <div class="form-control">
                        ...
                        >
                          <img
                            src="/icons/weapon/weapon-takt.png"
                            alt="Harmonizer"
                          />
                          ...
                          <input
                            ...
                            value="takt"
                            type="checkbox"
                            id={"form-checkbox-weapon-takt" + (i + 1)}
                            name={"form-checkbox-weapon" + (i + 1)}
                            class="checkbox rounded"
                          />
                        </label>
                    ...
                    <div class="form-control">
                      ...
                      {#if Number(selectedPartySize) == 1}
                        <input
                          ...
                          name={"video-form" + (i + 1)}
                          class="input-bordered input"
                          title="Link must be a valid Youtube link."
                          required
                        />
                      {:else}
                        <input
                      ...
                      <label class="label">
                        <span class="label-text-alt"
                          >Accepts any youtube link. (youtube.com, youtu.be...)<br
                          /><span class="text-warning"
                            >Additional site support coming soon!</span
                          ></span
                        >
                      </label>
                    </div>
            ...
            <div class="grid grid-cols-1 text-center">
              ...
              {#if selectedWeapons.length == 0 && Number(selectedPartySize) == 1}
                <span class="text-error"
                  >You need to pick at least one weapon!</span
                >
              {/if}
            </div>
          </form>
