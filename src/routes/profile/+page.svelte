<script lang="ts">
  ...
  function shipGenerate() {
    ...
    d.Server =
      serverref.charAt(0).toUpperCase() + serverref.slice(1).toLowerCase();
    return smile;
  }
    ...
    >
      ...
      >
        ...
        {#if d !== undefined && !d.Error}
          ...
          >
            <div
              class="avatar mr-0 place-self-center md:mr-2 md:place-self-auto"
            >
            ...
            >
              ...
              {/if}
              <div
                class="flex flex-col flex-wrap place-self-stretch md:flex-row"
              >
              ...
              >
                {#if d.AllianceID}
                  {#if d.AllianceIcon}
                    ...
                    />
                  {/if}
                  <span class="place-self-center font-semibold"
                    >{d.AllianceName}</span
                  >
          ...
          {#if d.Trophies}
            <div
              class="flex justify-center rounded-md border border-secondary bg-secondary/25 p-2"
            >
              <div class="flex grow flex-col">
                <span class="text-center text-lg font-semibold">Trophies:</span>
                <div
                  class="flex grow flex-row flex-wrap justify-center gap-8 p-2"
                >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            class="badge badge-lg place-self-center rounded border-0 font-semibold"
            >Profile Link</a
          >
        {:else if d !== undefined && d.Error}
          ...
          >
            Something went wrong. Please refresh.<br />If this error persists,
            leave a message in #bug-reports on Discord!
          </div>
        {:else}
          <div
            class="flex basis-full flex-col place-content-center place-items-center gap-1"
