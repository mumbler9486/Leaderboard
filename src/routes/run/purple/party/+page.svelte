...
<svelte:head>
	<title>{$t('shared.siteName')} | {$t('leaderboard.purpleTriggers')} - {$t('common.playerCount.party')}</title>
</svelte:head>

<div class="flex flex-col min-h-screen">
    <LeaderboardHeader/>

    <LeaderboardTitle category="{$t('leaderboard.purpleTriggers')}" subCategory="{$t('common.playerCount.party')}"/>
