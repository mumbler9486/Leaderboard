...
<HomeNews publicationDate="2023-02-10T00:00:00.000Z" title="Leaderboard February 2024 Updates">
	...
	<strong>💄Ongoing UI Improvements</strong><br />
	<p class="pt-2">
		...
		<div class="pt-2">
			...
			<div class="my-2 pl-2">
				<p>
					...
					executed is per run instead of by player "one". With that, all runs on the leaderboard
					have been assigned a run region (japan/global) based on evidence in your run's video
					(usually by fan translation distinction) if they have not before.
				</p>
				<p>
					2. Runs tied by time (1 second precision) are awarded the same rank. Times submitted
					earlier will still be ordered on first within the same time.
				</p>
				<p>
					3. We did not have "submission dates" for runs in the early days of the leaderboard. If
					your run was fairly old, we went by the youtube video's publication date.
				</p>
...
<HomeNews publicationDate="2023-08-10T00:00:00.000Z" title="Leaderboard 3.2.2 Update">
	<p>
		<li>
			...
			<p>
				A new boss Dark Falz Solus has been added to the leaderboard. The official release date for
				the quest is Aug 9, 2023.
			</p>
			<p class="pt-2">
				Some minor layout changes and some general improvements. This update prepares the
				leaderboard for the upcoming data migrations so we can improve the development speed of new
				quests and bosses as they are added into the game.
			</p>
			<p class="pt-2">
				As usual if there are issues please contact us on <DiscordContact />.
			</p>
...
<HomeNews publicationDate="2023-06-18T00:00:00.000Z" title="Leaderboard 3.2.1 Update">
	<li>
		...
		<p class="pt-2">
			Also we performed some minor data migrations in the backend. These should have no impact on
			the site operations but as usual if there are issues please contact us on <DiscordContact />.
		</p>
	</li>
</HomeNews>
