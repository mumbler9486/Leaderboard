	...
	<div class="flex grow flex-col content-center">
		<div class="container m-16 mx-auto flex grow rounded-md border border-secondary bg-base-100/75">
			...
			>
				...
				<span class="text-center">Streamer mode hides user avatars and user descriptions.</span
				><span class="text-center text-warning"
					>We don't allow overly NSFW content, but this can help add peace of mind if you want to
					show the leaderboard in live content!</span
				>
				<div class="divider -mx-8" />
				<div class="text-center text-2xl font-medium">
					Cookies
				...
				<div class="flex flex-col place-items-center">
					...
					<a
						...
						class="link-accent link">Please review our Privacy Policy for more information.</a
					>
