<script lang="ts">
  ...
  let consentPreferences =
    (browser ? localStorage.getItem("consent-preferences") ?? false : false) ===
    "true";
  let consentTwitch =
    (browser ? localStorage.getItem("consent-twitch") ?? false : false) ===
    "true";
  let consentGoogle =
    (browser ? localStorage.getItem("consent-google") ?? false : false) ===
    "true";
  let consentDiscord =
    (browser ? localStorage.getItem("consent-discord") ?? false : false) ===
    "true";
  let userStreamermode =
    (browser ? localStorage.getItem("user-streamermode") ?? "false" : false) ===
    "true";
    ...
    >
      ...
      >
        ...
        <span class="text-center"
          >Streamer mode hides user avatars and user descriptions.</span
        ><span class="text-center text-warning"
          >We don't allow overly NSFW content, but this can help add peace of
          mind if you want to show the leaderboard in live content!</span
        >
        <div class="divider -mx-8" />
        <div class="text-center text-2xl font-medium">
          Cookies
        ...
        <div class="flex flex-col place-items-center">
          <p class="mb-4 text-2xl font-light md:text-3xl">
            This website uses cookies.
          </p>
          <p class="mb-4">
            We use cookies (and local storage) to log you in and store your
            settings.
          </p>
          <a
            href="/privacy-policy"
          ...
          >
            ...
            <div class="collapse-content bg-base-100">
              ...
              <p class="mb-4">
                Registering stores information securely on our servers,
                including:
              </p>
              <p class="mb-4 font-semibold">
                Email Address, Username, and Player Name.
              </p>
              <p class="mb-4 text-xl font-semibold">Logging in:</p>
              <p class="mb-4">
                Logging in stores the following information as a cookie on your
                system, including:
              </p>
              <p class="mb-4 font-semibold">
          ...
          >
            ...
            <div class="collapse-content bg-base-100">
              ...
              <p class="mb-4">
                ...
                and are not saved to our servers.<br />They are, however,
                processed by our site to allow non-default functionality.<br
                /><br /><strong>Examples of user settings are:</strong>
              </p>
              <p class="mb-4">
                Your language preferences.<br />Leaderboard timer display
                preferences.<br />Streamer mode status.<br /><strong
                  >And other user settings.</strong
                >
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="collapse-content bg-base-100">
              ...
              <p class="mb-4">
                Enabling third-party cookies will allow Google to place their
                own trackers, cookies, and analytics on your system.
              </p>
              <p class="mb-4">
                In exchange, this allows us to enable Youtube embeds and other
                features.
              </p>
              <p class="my-4 text-xl font-semibold">Twitch:</p>
              <p class="mb-4">
                Enabling third-party cookies will allow Twitch.tv to place their
                own trackers, cookies, and analytics on your system.
              </p>
              <p class="mb-4">
                In exchange, this allows us to enable Twitch.tv embeds and other
                features.
              </p>
              <p class="my-4 text-xl font-semibold">Discord:</p>
              <p class="mb-4">
                Enabling third-party cookies will allow Discord to place their
                own trackers, cookies, and analytics on your system.
              </p>
              <p class="mb-4">
                In exchange, this allows us to enable the Discord widget on our
                home page.
              </p>
            </div>
          </div>
