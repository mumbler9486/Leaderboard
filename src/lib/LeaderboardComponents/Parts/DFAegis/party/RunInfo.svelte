		...
		<div class="widget-discord max-h-[20rem] overflow-auto md:max-h-[44rem]">
			{#if d.shared !== undefined}
				<div class="flex grow flex-col gap-1">
					...
					>
						<div class="flex flex-col place-content-center text-center md:flex-row md:flex-wrap">
					...
					<div class="flex flex-col gap-2 p-2 md:flex-row md:gap-0">
						<div class="flex basis-full flex-col justify-center md:flex-row md:flex-wrap">
							...
							<span class="basis-1/2">
								...
								{/if}
								{#if player1.PlayerID !== ('106' || '107')}
									<p class="flex place-content-center text-sm text-base-content/50 md:ml-1">
										({player1.NameOut2})
									</p>
								{/if}
							</span>
