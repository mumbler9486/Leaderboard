      ...
      <div class="max-h-[20rem] md:max-h-[44rem] overflow-auto widget-discord">
        ...
        <div class="flex flex-col gap-1 grow">
            <div class="flex basis-full justify-center bg-secondary/25 border border-secondary rounded-md p-2">
                <div class="flex flex-col md:flex-row md:flex-wrap text-center place-content-center">
                    <span class="font-semibold text-lg basis-full"><i class="bi bi-youtube"></i> POV Link(s):</span>
                    {#if player1.LinkPOV}
                    <span class="basis-1/2 flex flex-col">
                    ...
                    <span class="basis-1/2 flex flex-col">
                        ...
                        <span class="inline place-self-center">{player5.NameOut1}</span>
                        <a class="link link-primary" href={player5.LinkPOV} target="_blank" rel="noreferrer noopener">{player5.LinkPOV}</a>
                    ...
                    <span class="basis-1/2 flex flex-col">
                        ...
                        <span class="inline place-self-center">{player6.NameOut1}</span>
                        <a class="link link-primary" href={player6.LinkPOV} target="_blank" rel="noreferrer noopener">{player6.LinkPOV}</a>
                    ...
                    <span class="basis-1/2 flex flex-col">
                        ...
                        <span class="inline place-self-center">{player7.NameOut1}</span>
                        <a class="link link-primary" href={player7.LinkPOV} target="_blank" rel="noreferrer noopener">{player7.LinkPOV}</a>
                    ...
                    <span class="basis-1/2 flex flex-col">
                        ...
                        <span class="inline place-self-center">{player8.NameOut1}</span>
                        <a class="link link-primary" href={player8.LinkPOV} target="_blank" rel="noreferrer noopener">{player8.LinkPOV}</a>
            ...
            <div class="flex flex-col gap-2 md:gap-0 md:flex-row p-2">
                ...
                <div class="flex flex-col md:flex-row md:flex-wrap basis-full justify-center">
                    <p class="flex place-content-center basis-full">Run By:</p>
                    <span class="basis-1/2">
                        ...
                        {/if}
                        {#if player1.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center text-base-content/50 text-sm md:ml-1">({player1.NameOut2})</p>
                        {/if}
                    </span>
                    <div class="divider m-0"></div>
                    <span class="basis-1/2">
                        ...
                        <p class="flex place-content-center text-base-content/50 text-sm md:ml-1">({player2.NameOut2})</p>
                        {/if}  
                    </span>
                    <div class="divider m-0"></div>
                    <span class="basis-1/2">
                        ...
                        {/if}
                        {#if player3.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center text-base-content/50 text-sm md:ml-1">({player3.NameOut2})</p>
                        {/if}
                    </span>
                    <div class="divider m-0"></div>
                    <span class="basis-1/2">
                        ...
                        {/if}
                        {#if player4.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center text-base-content/50 text-sm md:ml-1">({player4.NameOut2})</p>
                        {/if}
                    </span>
                    <div class="divider m-0"></div>
                    <span class="basis-1/2">
                        {#if player5.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center"><a href="/users?id={player5.PlayerID}" target="_blank" rel="noreferrer noopener" style={player5.CSS} class="inline place-self-center">{player5.NameOut1}</a></p>
                        {:else}
                        <p style={player5.CSS} class="flex place-content-center">{player5.NameOut1}</p>
                        {/if}
                        {#if player5.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center text-base-content/50 text-sm md:ml-1">({player5.NameOut2})</p>
                        {/if}
                    </span>
                    <div class="divider m-0"></div>
                    <span class="basis-1/2">
                        {#if player6.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center"><a href="/users?id={player6.PlayerID}" target="_blank" rel="noreferrer noopener" style={player6.CSS} class="inline place-self-center">{player6.NameOut1}</a></p>
                        {:else}
                        <p style={player6.CSS} class="flex place-content-center">{player6.NameOut1}</p>
                        {/if}
                        {#if player6.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center text-base-content/50 text-sm md:ml-1">({player6.NameOut2})</p>
                        {/if}
                    </span>
                    <div class="divider m-0"></div>
                    <span class="basis-1/2">
                        {#if player7.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center"><a href="/users?id={player7.PlayerID}" target="_blank" rel="noreferrer noopener" style={player7.CSS} class="inline place-self-center">{player7.NameOut1}</a></p>
                        {:else}
                        <p style={player7.CSS} class="flex place-content-center">{player7.NameOut1}</p>
                        {/if}
                        {#if player7.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center text-base-content/50 text-sm md:ml-1">({player7.NameOut2})</p>
                        {/if}
                    </span>
                    <div class="divider m-0"></div>
                    <span class="basis-1/2">
                        {#if player8.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center"><a href="/users?id={player8.PlayerID}" target="_blank" rel="noreferrer noopener" style={player8.CSS} class="inline place-self-center">{player8.NameOut1}</a></p>
                        {:else}
                        <p style={player8.CSS} class="flex place-content-center">{player8.NameOut1}</p>
                        {/if}
                        {#if player8.PlayerID !== ('106' || '107')}
                        <p class="flex place-content-center text-base-content/50 text-sm md:ml-1">({player8.NameOut2})</p>
                        {/if}
                    </span>
                </div>
