          ...
          <table class="table table-compact table-zebra w-full">
            ...
            <tbody>
              {#each dataStorage as data}
                ...
                <SoloPurpleFull on:openRunInfo={runInfoOpen} buff={data.shared.Buff} time={data.shared.Time} runID={data.shared.RunID} notes={data.shared.Notes} myRank={func} player1={data.p1} player2={data.p2} player3={data.p3} player4={data.p4} player5={data.p5} player6={data.p6} player7={data.p7} player8={data.p8}/>
                {/each}
              {/each}
            </tbody>
            {/if}
