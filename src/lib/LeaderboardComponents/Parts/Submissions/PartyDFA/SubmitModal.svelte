<script lang="ts">
    ...
    async function denyRun() {
        ...
        processing = true;
        const response = await fetch('/ngs-api/DenyRun?type=dfaparty', {
            method: 'POST',
            headers: {
    ...
    async function approveRun() {
        ...
        processing = true;
        const response = await fetch('/ngs-api/ApproveRun?type=dfaparty', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
        ...
        <div class="flex flex-col gap-1 grow">
            ...
            <div class="flex flex-col gap-2 md:gap-0 md:flex-row p-2">
                ...
                <div class="flex flex-col basis-full justify-center">
                    ...
                    {/if}
                    {#if player5.NameOut1 !== player5.NameOut2 && player5.PlayerID !== ('106' || '107')}
                    <p class="flex place-self-center text-base-content/50 text-sm md:ml-1">({player5.NameOut2})</p>
                    {/if}
                    <div class="divider m-0"></div>
                    ...
                    {/if}
                    {#if player6.NameOut1 !== player6.NameOut2 && player6.PlayerID !== ('106' || '107')}
                    <p class="flex place-self-center text-base-content/50 text-sm md:ml-1">({player6.NameOut2})</p>
                    {/if}
                    <div class="divider m-0"></div>
                    ...
                    {/if}
                    {#if player7.NameOut1 !== player7.NameOut2 && player7.PlayerID !== ('106' || '107')}
                    <p class="flex place-self-center text-base-content/50 text-sm md:ml-1">({player7.NameOut2})</p>
                    {/if}
                    <div class="divider m-0"></div>
                    ...
                    {/if}
                    {#if player8.NameOut1 !== player8.NameOut2 && player8.PlayerID !== ('106' || '107')}
                    <p class="flex place-self-center text-base-content/50 text-sm md:ml-1">({player8.NameOut2})</p>
                    {/if}
                </div>
