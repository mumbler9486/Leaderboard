  ...
  function generateNames(null1,null2,null3) {
        ...
        if (d.PlayerID != (106 || 107)) {
            ...
            previewcss += `color: #` + d.previewc1 + `;`
                break;
            case 2:
            previewcss += `background: -webkit-linear-gradient(0deg, #` + d.previewc1 + `, #` + d.previewc2 + `);
                            -webkit-background-clip: text;
                            -webkit-text-fill-color: transparent;`;
                break;
            case 3:
            previewcss += `color: #` + d.previewc2 + `; text-shadow: 0px 0px 5px #` + d.previewc1 + `, 0px 0px 5px #` + d.previewc1 + `, 0px 0px 5px #` + d.previewc1 + `;`;
                break;
            default:
                break;
            }
...
$: {
  generateNames(d.previewc1, d.previewc2, d.previewnametype, d.previewcharname, d.previewprefname);
}
...
<div class="modal">
  <div class="modal-box relative rounded max-w-4xl max-h-full">
  {#if !processingInput}
    <div class="flex flex-row">
        <span class="flex-1 font-light text-3xl md:text-4xl self-center">Edit ARKs ID</span>
    ...
    <div class="max-h-[20rem] md:max-h-[44rem] overflow-auto widget-discord px-1">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
        <div class="form-control">
          ...
          <input id="charname-form" type="text" on:input={() => d.previewcharname = document.getElementById('charname-form').value} placeholder="Please enter a character name." class="input input-bordered" maxlength="24" required />
        </div>
        ...
        <div class="form-control">
          ...
          <select id="namepref-form" class="select select-bordered" on:change={() => d.previewprefname = Number(document.getElementById('namepref-form').value)}>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
        <div class="form-control">
          ...
          <label class="input-group">
            ...
            <input id="social-youtube1-form" placeholder="..." type="text" class="input input-bordered w-full" maxlength="30" />
          </label>
        </div>
        <div class="form-control">
          ...
          <label class="input-group">
            <span>youtube.com/@</span>
            <input id="social-youtube2-form" placeholder="..." type="text" class="input input-bordered w-full" maxlength="30" />
          </label>
        </div>
      </div>
      <div class="text-warning text-center">These are your Youtube channel(s) '@' handle(s), excluding the '@'!</div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
        <div class="form-control">
          ...
          <label class="input-group">
            ...
            <input id="social-twitter-form" placeholder="..." type="text" class="input input-bordered w-full" maxlength="30" />
          </label>
        </div>
        <div class="form-control">
          ...
          <label class="input-group">
            <span>twitch.tv/</span>
            <input id="social-twitch-form" placeholder="..." type="text" class="input input-bordered w-full" maxlength="30" />
          </label>
        </div>
        <div class="form-control">
          ...
          <input id="social-discord-form" type="text" placeholder="Name#1234" class="input input-bordered w-full" />
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
        <div class="form-control">
          ...
          <select id="shipselect-form" class="select select-bordered">
        ...
        <div class="form-control">
          ...
          <select id="country-form" class="select select-bordered widget-discord">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
        <div class="form-control">
          <label class="label" for="color1-form">
            ...
            <input id="color1-form" type="color" on:input={() => d.previewc1 = document.getElementById('color1-form').value.replace('#','')} class="input input-bordered w-full" />
        </div>
        <div class="form-control">
          <label class="label" for="color2-form">
            <span class="label-text">Secondary Color</span>
          </label>
            <input id="color2-form" type="color" on:input={() => d.previewc2 = document.getElementById('color2-form').value.replace('#','')} class="input input-bordered w-full" />
        </div>
        <div class="form-control">
          <label class="label" for="nametype-form">
            <span class="label-text">Name Effect</span>
          </label>
          <select id="nametype-form" class="select select-bordered" on:change={() => d.previewnametype = Number(document.getElementById('nametype-form').value)}>
      ...
      <div class="form-control">
        ...
        <textarea class="textarea textarea-bordered h-24 widget-discord" placeholder="Type your own profile here!" id="description-form"></textarea>
    ...
    <div class="modal-action justify-center md:justify-end">
      <label for={modalID} class="btn md:btn-sm btn-error btn-outline rounded">Cancel</label>
      <button class="btn md:btn-sm btn-success btn-outline rounded" type="submit" form="editingForm">Save</button>
    </div>
    {:else}
