  ...
  async function submitChanges() {
    ...
    const response = await fetch("/ngs-api/UpdateProfile", {
      ...
      body: JSON.stringify({
        ...
        newNameC1: document
          .getElementById("color1-form")
          .value.replace("#", ""),
        newNameC2: document
          .getElementById("color2-form")
          .value.replace("#", ""),
...
<div class="modal">
  <div class="modal-box relative max-h-full max-w-4xl rounded">
    {#if !processingInput}
      ...
      <div
        class="widget-discord max-h-[20rem] overflow-auto px-1 md:max-h-[44rem]"
      >
        <form id="editingForm" on:submit={submitChanges}>
          <div class="grid grid-cols-1 gap-2 md:grid-cols-2">
            <div class="form-control">
              ...
              <input
                ...
                on:input={() =>
                  (d.previewcharname =
                    document.getElementById("charname-form").value)}
            ...
            <div class="form-control">
              ...
              <select
                ...
                on:change={() =>
                  (d.previewprefname = Number(
                    document.getElementById("namepref-form").value
                  ))}
              >
          ...
          <div class="grid grid-cols-1 gap-2 md:grid-cols-2">
            ...
            <div class="form-control">
              ...
              <select
                id="country-form"
                class="widget-discord select-bordered select"
              >
          ...
          <div class="grid grid-cols-1 gap-2 md:grid-cols-3">
            ...
            <div class="form-control">
              ...
              <select
                ...
                class="select-bordered select"
                on:change={() =>
                  (d.previewnametype = Number(
                    document.getElementById("nametype-form").value
                  ))}
              >
      ...
      <div class="modal-action justify-center md:justify-end">
        <label for={modalID} class="btn-outline btn-error btn rounded md:btn-sm"
          >Cancel</label
        >
        <button
