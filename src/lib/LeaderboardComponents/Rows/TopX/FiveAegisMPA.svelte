    ...
    <th>
      <p>
        <span class="flex items-center"
          ...
          /><span style={data.p1.CSS} class="truncate"
            >{data.p1.PrimaryName}</span
          ></span
      ...
      <p class="mt-2">
        <span class="flex items-center"
          ...
          /><span style={data.p2.CSS} class="truncate"
            >{data.p2.PrimaryName}</span
          ></span
      ...
      <p class="mt-2">
        <span class="flex items-center"
          ...
          /><span style={data.p3.CSS} class="truncate"
            >{data.p3.PrimaryName}</span
          ></span
      ...
      <p class="mt-2">
        <span class="flex items-center"
          ...
          /><span style={data.p4.CSS} class="truncate"
            >{data.p4.PrimaryName}</span
          ></span
      ...
      <p class="mt-2">
        <span class="flex items-center"
          ...
          /><span style={data.p5.CSS} class="truncate"
            >{data.p5.PrimaryName}</span
          ></span
      ...
      <p class="mt-2">
        <span class="flex items-center"
          ...
          /><span style={data.p6.CSS} class="truncate"
            >{data.p6.PrimaryName}</span
          ></span
      ...
      <p class="mt-2">
        <span class="flex items-center"
          ...
          /><span style={data.p7.CSS} class="truncate"
            >{data.p7.PrimaryName}</span
          ></span
      ...
      <p class="mt-2">
        <span class="flex items-center"
          ...
          /><span style={data.p8.CSS} class="truncate"
            >{data.p8.PrimaryName}</span
          ></span
