...
{#if consent === null}
  <div
    class="fixed bottom-0 left-0 right-0 z-50 md:bottom-10 md:left-auto md:right-10"
  >
    <div
    ...
    >
      <div class="flex flex-col place-items-center">
        ...
        {#if customize == 1}
          ...
          >
        {/if}
        <p class="font-semibold text-neutral-content">
      ...
      <div>
        ...
        <button
          class="btn-secondary btn-sm btn rounded-none md:btn-md"
          on:click={toggleCustomize}>Customize</button
        >
      </div>
    </div>
  </div>
