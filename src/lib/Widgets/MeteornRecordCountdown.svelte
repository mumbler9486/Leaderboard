			...
			<div class="grow flex-col md:flex-row">
				{#if !(new Date().getTime() > dateEnd)}
					<div>
						...
						<div style="filter: drop-shadow(0 0 0.25rem black) drop-shadow(0 0 0.125rem black);">
							{recordDescription}
						</div>
						<div style="filter: drop-shadow(0 0 0.25rem black) drop-shadow(0 0 0.125rem black);">
				...
				{/if}
				<div class="ml-0 grid auto-cols-max grid-flow-col gap-2 text-center md:ml-auto">
					<div
