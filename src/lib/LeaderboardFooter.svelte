    ...
    <div class="container mx-auto px-2 pb-8 pt-4">
        <div class="grid grid-cols-3">
            <span class="text-left text-neutral-content">
                ...
                <br>
                ⒸSEGA PHANTASY STAR ONLINE 2 <a href="http://pso2.com">http://pso2.com</a>.
                <br>
            ...
            <span class="text-center text-neutral-content">
                ...
                <br>
                Hosting & Database provided by BigDaddyCool.
                <br>
                Logo Editing and Background Screenshots by Sukeboy.
                <br>
                PSO2Central Arks Star by Niles.
                <br>
                <a href="/privacy-policy" target="_blank" rel="noreferrer noopener" class="link link-primary no-underline">Privacy Policy</a>
                <a href="/tos" target="_blank" rel="noreferrer noopener" class="link link-primary no-underline">Terms of Service</a>
            </span>
            <span class="text-right text-neutral-content">
                <strong>Social</strong>
                <br>
                <a href="https://discord.com/invite/fFtEEJHuFp" target="_blank" rel="noreferrer noopener" class="link link-primary no-underline">Discord <i class="bi bi-discord"></i></a>
            </span>
        </div>
    </div>
</footer>